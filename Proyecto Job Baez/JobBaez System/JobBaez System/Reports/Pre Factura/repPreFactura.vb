...
Public Class repPreFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JobBaez_System.repPreFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepPreFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repPreFactura = New repPreFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
