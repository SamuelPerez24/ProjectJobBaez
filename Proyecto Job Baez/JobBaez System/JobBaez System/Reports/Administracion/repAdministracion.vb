...
Public Class repAdministracion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JobBaez_System.repAdministracion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAdministracion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAdministracion = New repAdministracion()
        rpt.Site = Me.Site
        Return rpt
    End Function
